...
struct ponteiros{
    ...
    void EXERCICIO_1(){
        ...
        int a,b,c,d,e,f,g,h,i,j;
         ...
         system("cls");
        cout << "Endereço de Memoria: " <<&a <<" Valor: " <<a << endl;
        cout << "Endereço de Memoria: " <<&b <<" Valor: " <<b<< endl;
        cout << "Endereço de Memoria: " <<&c <<" Valor: " <<c<< endl;
        cout << "Endereço de Memoria: " <<&d <<" Valor: " <<d<< endl;
        cout << "Endereço de Memoria: " <<&e <<" Valor: " <<e<< endl;
        cout << "Endereço de Memoria: " <<&f <<" Valor: " <<f<< endl;
        cout << "Endereço de Memoria: " <<&g <<" Valor: " <<g<< endl;
        cout << "Endereço de Memoria: " <<&h <<" Valor: " <<h<< endl;
        cout << "Endereço de Memoria: " <<&i <<" Valor: " <<i<< endl;
        cout << "Endereço de Memoria: " <<&j <<" Valor: " <<j<< endl;
     ...
     void EXERCICIO_2(){
        ...
        cin >> f;
        cout << "Insira o valor de g: ";
        cin >> g;
        cout << "Insira o valor de h: ";
        cin >> h;
        cout << "Insira o valor de i: ";
        cin >> i;
        cout << "Insira o valor de j: ";
        cin >> j;
     ...
     void EXERCICIO_3(){
        ...
        cout << "Utilizando vetores:" << endl;


        int vet[10];
        for(int i = 0; i<10;++i){
            cout << "Endereço de Memoria: " <<&vet[i] <<" Valor: " <<vet[i]<< endl;
        }
        cout << endl << endl;
        cout << "Agora inserindo valores:" << endl;
        for(int i = 0; i<10;++i){
      ...
      void EXERCICIO_4(){
        ...
        cout << "Utilizando Matriz:" << endl << endl;


        int vet[10][2];
        for(int i = 0; i<10;++i){
            for(int j = 0; j < 2; ++j){
                cout << "Endereço de Memoria: " <<&vet[i][j] <<" Valor: " <<vet[i]<< endl;
            }
        }
        cout << endl << endl;
        cout << "Agora inserindo valores:" << endl;
        for(int i = 0; i<10;++i){
            for(int j = 0; j<2; ++j){
                cout << "Insira os valores no vetor:";
                cin >> vet[i][j];
                cout << "Endereço de Memoria: " <<&vet[i][j] <<" Valor: " <<vet[i][j]<< endl;
            }
        }
...
void ponteiros_menu(){
    ...
    do{
        ...
        cout << " 2 - EXERCICIO_2 " << endl;
        cout << " 3 - EXERCICIO_3 " << endl;
        cout << " 4 - EXERCICIO_4 " << endl;
        cout << " 0 - SAIR " << endl;
        cin >> opcao;
        cin.ignore(80,'\n');
        Sleep(200);
        ...
        switch(opcao){
            case 1: exercicio.EXERCICIO_1();
            break;
            case 2: exercicio.EXERCICIO_2();
            break;
            case 3: exercicio.EXERCICIO_3();
            break;
            case 4: exercicio.EXERCICIO_4();
            break;
...
int submenuEncadeado() {
    ...
    std::cout << " 1-Adicionar Elemento Comeco" << std::endl;
    std::cout << " 2-Adicionar Elemento Fim" << std::endl;
    std::cout << " 3-Remover Elemento Comeco" << std::endl;
    std::cout << " 4-Remover Elemento Fim" << std::endl;
    std::cout << " 5-Visualizar Elementos" << std::endl;
    std::cout <<" 6-Buscar Elementos" << std::endl;
    std::cout <<" 7-Ordenacao Crescente" << std::endl;
    std::cout <<" 8-Ordenacao Decrescente" << std::endl;
...
do{
    ...
    cout << " 1 - FILA " << endl;
    cout << " 2 - PILHA " << endl;
    cout << " 3 - Ponteiros" <<endl;
    cout << " 4 - No encadeado" << endl;
    cout << " 0 - SAIR " << endl;
    cin >> opcao;
    cin.ignore(80,'\n');
    Sleep(200);
    ...
    switch(opcao){
        ...
        break;
        case 3: escolha3.ponteiros_menu();
        break;
        case 4: submenuEncadeado();
        break;
        case 0: break;
        default:
